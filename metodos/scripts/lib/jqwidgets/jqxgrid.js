...
(function (b) {
    ...
    b.extend(b.jqx._jqxGrid.prototype, {
        ...
        _resizeWindow: function () {
            ...
            if ((this.width != null && this.width.toString().indexOf("%") != -1) || (this.height != null && this.height.toString().indexOf("%") != -1)) {
                ...
                b.jqx.utilities.resize(this.host, function () {
                    ...
                    if (d._lastHostWidth != f || d._lastHostHeight != h) {
                        d._updatesize(d._lastHostWidth != f, d._lastHostHeight != h)
                    }
                    d._lastWidth = g;
                    d._lastHeight = e;
                    d._lastHostWidth = f;
        ...
        _updatesize: function (i, h) {
            ...
            var d = b.jqx.browser.msie ? 10 : 10;
        ...
        _initmenu: function () {
            ...
            if (this.host.jqxMenu) {
                ...
                var z = '<div class="jqx-grid-sortdesc-icon"></div>';
                var w = b("<li>" + z + this.gridlocalization.sortdescendingstring + "</li>");
                ...
                var u = b('<li class="filter" style="height: 170px;" ignoretheme="true"><div class="filter"></div></li>');
                ...
                if (this.filterable && !this.showfilterrow && this.showfiltermenuitems) {
                    if (this._initfilterpanel) {
                        this.menuitemsarray[5] = u[0];
                        this.menuitemsarray[6] = u[0];
                        v.append(d);
                        v.append(u);
                        l += 176;
                        ...
                        var o = b(u).find("div:first");
                        x += 20;
                        this._initfilterpanel(this, o, "", x);
                        p = false;
                ...
                this.addHandler(this.gridmenu, "keydown", function (E) {
                    if (E.keyCode == 27) {
                        ...
                        if (E.keyCode == 13 && r.filterable) {
                            if (r._buildfilter) {
                                var D = b(b.find("#filter1" + r.element.id)).jqxDropDownList("container").css("display") == "block";
                                var C = b(b.find("#filter2" + r.element.id)).jqxDropDownList("container").css("display") == "block";
                                var A = b(b.find("#filter3" + r.element.id)).jqxDropDownList("container").css("display") == "block";
                                var F = b(b.find("#filterclearbutton" + r.element.id)).hasClass("jqx-fill-state-focus");
                                if (F) {
                                    var B = b.data(document.body, "contextmenu" + r.element.id).column;
                                    r._clearfilter(r, r.element, B);
                                    r.gridmenu.jqxMenu("close")
                                } else {
                                    if (!D && !C && !A) {
                                        var B = b.data(document.body, "contextmenu" + r.element.id).column;
                                        r.gridmenu.jqxMenu("close");
                                        r._buildfilter(r, u, B)
                                    }
                                }
                            }
                        }
                ...
                if (this.filterable) {
                    this.gridmenu.jqxMenu("_setItemProperty", u[0].id, "closeOnClick", false)
                }
                if (this.rtl) {
                    var y = this;
                    b.each(v.find("li"), function () {
                        b(this).addClass(y.toTP("jqx-rtl"))
                    });
                    var h = function (A) {
                        var B = A.find("div");
                        B.css("float", "right");
        ...
        _render: function (h, i, g, d, f) {
            ...
            this._addHandlers();
            this._initializeRows();
            this._requiresupdate = i != undefined ? i : true;
            this._newmax = null;
            if (g) {
        ...
        _updatecolumnwidths: function () {
            ...
            b.each(this.columns.records, function (n, o) {
                if (!(this.hidden && this.hideable)) {
                    if (this.width.toString().indexOf("%") != -1 || this._percentagewidth != undefined) {
                        var o = 0;
                        var p = m.vScrollBar[0].style.visibility == "hidden" ? 0 : m.scrollbarsize + 5;
                        o = parseInt(this.width) * e / 100;
                        if (this._percentagewidth != undefined) {
                            o = parseInt(this._percentagewidth) * (e - p) / 100
                        }
                ...
                if (this.virtualsizeinfo && this.virtualsizeinfo.virtualheight > f) {
                    if (this.groupable && this.groups.length > 0) {
                        if (this.dataview && this.dataview.loadedrootgroups && !this.groupsexpandedbydefault) {
                            var l = this.dataview.loadedrootgroups.length * this.rowsheight;
                            if (this.pageable) {
            ...
            var i = h.find(".jqx-grid-column-header");
            var g = 0;
            b.each(this.columns.records, function (o, s) {
                var q = b(i[o]);
                var n = false;
                var r = this.width;
                if (this.width.toString().indexOf("%") != -1 || this._percentagewidth != undefined) {
                    if (this._percentagewidth != undefined) {
                        r = parseInt(this._percentagewidth) * e / 100

                    } else {
                        r = parseInt(this.width) * e / 100
                    }
                    n = true
                }
                if (this.width != "auto" && !this._width && !n) {
                    if (parseInt(q[0].style.width) != this.width) {
                        q.width(this.width)
                    }
                } else {
                    if (n) {
                        ...
                        if (parseInt(q[0].style.width) != r) {
                            q.width(r);
                            this.width = r
                        }
                    } else {
                        var p = Math.floor(k * (this.text.length / j.length));
                        if (isNaN(p)) {
                            p = this.minwidth
                        }
                        if (p < 0) {
                        ...
                        k -= p;
                        j = j.substring(this.text.length);
                        this._width = "auto";
                        this.width = p;
                        q.width(this.width)
                    }
                } if (parseInt(q[0].style.left) != g) {
                    q.css("left", g)
                }
                if (!(this.hidden && this.hideable)) {
                    g += this.width
        ...
        _rendercolumnheaders: function () {
            ...
            if (!this.rtl) {
                for (var y = 0; y < e.length; y++) {
                    this.columns.replace(y, e[y])
                }
                for (var x = 0; x < v.length; x++) {
                    this.columns.replace(e.length + x, v[x])
                }
            } else {
                var u = 0;
                e.reverse();
                for (var y = this.columns.records.length - 1; y >= this.columns.records.length - e.length; y--) {
                    this.columns.replace(y, e[u++])
                }
                for (var x = 0; x < v.length; x++) {
                    this.columns.replace(x, v[x])
                }
            }
            ...
            if (this.virtualsizeinfo && this.virtualsizeinfo.virtualheight > r) {
                if (this.groupable && this.groups.length > 0) {
                    if (this.dataview && this.dataview.loadedrootgroups && !this.groupsexpandedbydefault) {
                        var z = 0;
                        if (!this.pageable) {
                            var z = this.dataview.loadedrootgroups.length * this.rowsheight
                        } else {
                            if (this.pageable) {
                                for (var s = 0; s < this.dataview.rows.length; s++) {
                                    if (this.dataview.rows[s].group && this.dataview.rows[s].level === 0) {
                                        z += this.rowsheight
                                    }
                                }
                            }
            ...
            var d = function (j, k) {
                var i = t.columngroupslevel * t.columnsheight;
                i = i - (k.level * t.columnsheight);
                return i
            };
            b.each(this.columns.records, function (R, P) {
                this.height = t.columnsheight;
                if (t.columngroups) {
                    if (t.columngroups.length) {
                        this.height = d(this.datafield, this);
                        g = this.height
                    }
                }
                var V = t.toTP("jqx-grid-column-header") + " " + t.toTP("jqx-widget-header");
                if (t.rtl) {
                    V += " " + t.toTP("jqx-grid-column-header-rtl")
                }
                var T = !t.rtl ? 50 + h - 1 : 50 + h + 1;
                var N = !t.rtl ? h-- : h++;
                var C = b('<div role="columnheader" style="z-index: ' + N + ';position: absolute; height: 100%;" class="' + V + '"><div style="height: 100%; width: 100%;"></div></div>');
                if (t.columngroups) {
                    C[0].style.height = g + "px";
                    C[0].style.bottom = "0px";
                    if (this.pinned) {
                        C[0].style.zIndex = T
                    }
                }
                ...
                if (this.classname != "" && this.classname) {
                    C.addClass(this.classname)
                }
                var K = this.width;
                var L = false;
                if (this.width.toString().indexOf("%") != -1 || this._percentagewidth != undefined) {
                    if (this._percentagewidth != undefined) {
                        K = parseInt(this._percentagewidth) * n / 100
                    } else {
                        K = parseInt(this.width) * n / 100
                    }
                    L = true
                ...
                if (this.width != "auto" && !this._width && !L) {
                    ...
                    if (L) {
                        ...
                        var O = Math.round(B * (this.text.length / o.length));
                        if (isNaN(O)) {
                            O = this.minwidth
                        }
                        if (O < 0) {
                        ...
                        this.width = O;
                        B -= O;
                        o = o.substring(this.text.length);
                        K = this.width;
                        C.width(this.width)
                    }
                } if (this.hidden && this.hideable) {
                ...
                var p = b(C.children()[0]);
                var S = t.rtl ? t.toTP("jqx-grid-column-menubutton") + " " + t.toTP("jqx-grid-column-menubutton-rtl") : t.toTP("jqx-grid-column-menubutton");
                var F = b('<div style="height: ' + g + 'px; display: none; left: 100%; top: 0%; position: absolute;"><div class="' + S + '" style="width: 100%; height:100%;"></div></div>');
                if (!t.enableanimations) {
                    F.css("margin-left", -16)
                }
                if (t.rtl) {
                    F.css("left", "0px")
                }
                this.columnsmenu = F[0];
                l[0].cells[R] = C[0];
                F[0].style.width = parseInt(t.columnsmenuwidth) + "px";
                var E = t.columnsmenu;
                var q = false;
                var Q = false;
                var M = (t.groupable && m > 0 && w < m) || (t.rowdetails && w < m);
                if (t.rtl) {
                    M = (t.groupable && m > 0 && w < m) || (t.rowdetails && w < m);
                    M &= R > t.columns.records.length - 1 - m
                }
                if (M) {
                    w++;
                    E &= false;
                    ...
                    var H = this.renderer != null ? this.renderer(this.text, this.align, g) : t._rendercolumnheader(this.text, this.align, g, t);
                    if (H == null) {
                        H = t._rendercolumnheader(this.text, this.align, g, t)
                    }
                    ...
                    var J = b('<div class="iconscontainer" style="height: ' + g + 'px; margin-left: -32px; display: block; position: absolute; left: 100%; top: 0%; width: 32px;"><div class="filtericon ' + t.toTP("jqx-widget-header") + '" style="height: ' + g + 'px; float: right; display: none; width: 16px;"><div class="' + t.toTP("jqx-grid-column-filterbutton") + '" style="width: 100%; height:100%;"></div></div><div class="sortasc ' + t.toTP("jqx-widget-header") + '" style="height: ' + g + 'px; float: right; display: none; width: 16px;"><div class="' + t.toTP("jqx-grid-column-sortascbutton") + '" style="width: 100%; height:100%;"></div></div><div class="sortdesc ' + t.toTP("jqx-widget-header") + '" style="height: ' + g + 'px; float: right; display: none; width: 16px;"><div class="' + t.toTP("jqx-grid-column-sortdescbutton") + '" style="width: 100%; height:100%;"></div></div></div>');
                ...
                if (E) {
                    t._handlecolumnsmenu(t, p, C, F, this);
                    if (!this.menu) {
                        F.hide()
                    }
                }
                l.append(C);
                if (t.groupable && q) {
                    C[0].id = t.dataview.generatekey();
                    if (t._handlecolumnstogroupsdragdrop) {
                        t._handlecolumnstogroupsdragdrop(this, C)
                    } else {
                        throw new Error("jqxGrid: Missing reference to jqxgrid.grouping.js.")
                    }
                }
                if (t.columnsreorder && this.draggable && t._handlecolumnsdragreorder) {
                    t._handlecolumnsdragreorder(this, C)
                }
                var U = this;
                t.addHandler(C, "click", function (i) {
                    if (U.checkboxcolumn) {
                        return true
                    }
                    ...
                    i.preventDefault();
                    t._raiseEvent(7, {
                        column: U.getcolumnproperties(),
                        datafield: U.datafield,
                        originalEvent: i
                    })
                });
                if (U.resizable && t.columnsresize && !Q) {
                    var D = false;
                    var j = "mousemove";
                    if (t.isTouchDevice()) {
                        D = true;
                    ...
                    t.addHandler(C, j, function (X) {
                        var i = parseInt(X.pageX);
                        var Z = 5;
                        var ac = parseInt(C.coord().left);
                        if (t.hasTransform) {
                            ac = b.jqx.utilities.getOffset(C).left
                        }
                        if (t._handlecolumnsresize) {
                            if (D) {
                                var Y = t.getTouches(X);
                                var ab = Y[0];
                                i = ab.pageX;
                                Z = 40;
                                if (i >= ac + U.width - Z) {
                            ...
                            if (i >= ac + aa - Z) {
                                ...
                                C.css("cursor", "");
                                if (i < ac + aa - Z) {
                                    if (!U._animating && !U._menuvisible) {
                                        C.mouseenter()
                                    }
                                }
                                t.resizablecolumn = null
                ...
                if (U.rendered) {
                    var I = U.rendered(b(p[0].firstChild), U.align, g);
                    if (I && J != null) {
                        J.hide()
                    }
                }
                if (U.checkboxcolumn) {
                    ...
                    U.checkboxelement = k;
                    var G = k.data().jqxCheckBox.instance;
                    t._checkboxcolumn = U;
                    G.updated = function (X, i, Y) {
                        t._checkboxcolumnupdating = true;
                        if (i) {
                            t.selectallrows()
                        } else {
                            t.clearselection(true, false)
                        }
                        t._checkboxcolumnupdating = false
                    }
                }
            });
            if (f > 0) {
            ...
            if (this.showfilterrow && this._updatefilterrow) {
                if (!this.columngroups) {
                    ...
                    var A = b("<div></div>");
                    A[0].id = "filterrow." + this.element.id;
                    A.height(this.filterrowheight);
                    this.filterrow = A
                }
        ...
        _rendercolumnheader: function (h, i, e, d) {
            ...
            if (d.columngroups) {
                ...
                return '<div style="overflow: hidden; text-overflow: ellipsis; text-align: ' + i + "; margin-left: 4px; margin-right: 2px; margin-bottom: " + g + "; margin-top: " + g + ';"><span style="text-overflow: ellipsis; cursor: default;">' + h + "</span></div>"
            }
            if (i == "center" || i == "middle") {
                return '<div style="text-align: center; margin-top: ' + g + ';"><a href="#">' + h + "</a></div>"
            }
        ...
        _getvisualcolumnsindexes: function (e, m, i, l, d) {
            if (this.rowdetails || this.rtl || (this.width && this.width.toString().indexOf("%") >= 0)) {
                return {
                    start: 0,
                    end: i + l
                }
            ...
            if (f && e.bounddata != null) {
                if (this.selectionmode != "singlerow") {
                    if (this.dataview.filters.length > 0) {
                        if (this.selectedrowindexes.indexOf(e.bounddata.dataindex) != -1) {
                            d = true
                        }
                    } else {
        ...
        _rendercell: function (n, g, t, o, f, k) {
            var h = o + "_" + g.visibleindex;
            if (g.columntype == "number" || g.cellsrenderer != null) {
                var h = t.uniqueid + "_" + g.visibleindex
            }
            if (n.editcell && n.editrow == undefined) {
                if (n.editcell.row == n.getboundindex(t) && n.editcell.column == g.datafield) {
                    n.editcell.element = f;
                    if (n.editcell.editing) {
                        if (n._showcelleditor) {
                            if (!n.hScrollInstance.isScrolling() && !n.vScrollInstance.isScrolling()) {
                                n._showcelleditor(n.editcell.row, g, n.editcell.element, n.editcell.init)
                            } else {
                                n._showcelleditor(n.editcell.row, g, n.editcell.element, n.editcell.init, false)
                            }
                            return
                        }
                    }
                ...
                if (n.editrow != undefined) {
                    if (n.editrow == n.getboundindex(t)) {
                        n.editcells[g.datafield].element = f;
                        if (n.editcells[g.datafield].editing) {
                            if (n._showcelleditor) {
                                n._showcelleditor(n.editcells[g.datafield].row, g, f, n.editcells[g.datafield].init);
                                return
                            }
                        }
                    }
            ...
            var p = n._defaultcellsrenderer(o, g);
            var m = n._cellscache[h];
            if (m) {
                if (g.columntype == "inline") {
                    n._renderinlinecell(n, f, g, t, o);
                    if (g.cellsrenderer != null) {
                        var i = g.cellsrenderer(n.getboundindex(t), g.datafield, o, p, g.getcolumnproperties(), t.bounddata);
                        if (i != undefined) {
                            f.innerHTML = i
                        }
                    }
                    ...
                    if (g.columntype == "checkbox") {
                        if (n.host.jqxCheckBox) {
                            if (o === "") {
                                o = null
                            }
                            var l = f.innerHTML.toString().length == 0;
                            if (f.checkbox && !n.groupable && !l) {
                                f.checkboxrow = n.getboundindex(t);
                                if (o == "") {
                                    o = false
                                }
                                if (o == "1") {
                                ...
                                if (o == null && !g.threestatecheckbox) {
                                    o = false
                                }
                                if (g.checkboxcolumn) {
                                    o = false;
                                    if (n.dataview.filters.length > 0) {
                                        if (n.selectedrowindexes.indexOf(t.bounddata.dataindex) != -1) {
                                            o = true
                                        }
                                    } else {
                                        if (n.selectedrowindexes.indexOf(t.bounddata.boundindex) != -1) {
                                            o = true
                                        }
                                    }
                                }
                                if (f.checkboxinstance) {
                                    f.checkboxinstance._setState(o)
                                } else {
                                    f.checkbox.jqxCheckBox("_setState", o)
                                }
                            } else {
                                n._rendercheckboxcell(n, f, g, t, o)
                            } if (g.cellsrenderer != null) {
                                var i = g.cellsrenderer(n.getboundindex(t), g.datafield, o, p, g.getcolumnproperties(), t.bounddata);
                                if (i != undefined) {
                                    f.innerHTML = i
                        ...
                        if (g.columntype == "button") {
                            if (n.host.jqxButton) {
                                if (o == "") {
                                    o = false
                                }
                                if (g.cellsrenderer != null) {
                                    o = g.cellsrenderer(n.getboundindex(t), g.datafield, o, p, g.getcolumnproperties(), t.bounddata)
                                }
                                if (f.innerHTML == "") {
                                    f.buttonrow = n.getboundindex(t);
                                    f.button = null;
                                    n._renderbuttoncell(n, f, g, t, o)
                                }
                                if (f.button && !n.groupable) {
                                    f.buttonrow = n.getboundindex(t);
                                    f.button.val(o)
                                } else {
                                    n._renderbuttoncell(n, f, g, t, o)
                ...
                var e = m.element;
                if (g.cellsrenderer != null || (f.childNodes && f.childNodes.length == 0) || n.groupable || n.rowdetails) {
                    if (f.innerHTML != e) {
                        f.innerHTML = e
                    }
                } else {
                    if (f.innerHTML.indexOf("editor") >= 0) {
                        f.innerHTML = e
                    } else {
                        if (k) {
                            var r = e.indexOf(">");
                            var s = e.indexOf("</");
                            var q = e.substring(r + 1, s);
                            var d = f.childNodes[0];
                            if (d.childNodes[0]) {
                                if (q != d.childNodes[0].nodeValue) {
                                    d.childNodes[0].nodeValue = q
                                }
                            } else {
                ...
                } if (n.enabletooltips && g.enabletooltips) {
                    f.title = m.title
                }
                return
            }
            ...
            var e = null;
            if (g.cellsrenderer != null) {
                e = g.cellsrenderer(n.getboundindex(t), g.datafield, o, p, g.getcolumnproperties(), t.bounddata)
            } else {
                e = p
            } if (e == null) {
                e = p
            ...
            if (n.WinJS) {
                WinJS.Utilities.setInnerHTMLUnsafe(f, e)
            } else {
                f.innerHTML = e
            }
            n._cellscache[h] = {
        ...
        getrows: function () {
            var g = this.dataview.records.length;
            if (this.virtualmode) {
                var h = new Array();
                ...
                var f = 0;
                if (this.pageable) {
                    f = this.dataview.pagenum * this.dataview.pagesize
                }
                if (h.length > this.source._source.totalrecords - f) {
                    return h.slice(0, this.source._source.totalrecords - f)
                }
                return h
            }
        ...
        destroy: function () {
            if (this.host.jqxDropDownList) {
                var d = b(b.find("#filterclearbutton" + this.element.id));
                var m = b(b.find("#filterbutton" + this.element.id));
                var f = b(b.find("#filter1" + this.element.id));
                var g = b(b.find("#filter2" + this.element.id));
                var l = b(b.find("#filter3" + this.element.id));
                var j = b(b.find(".filtertext1" + this.element.id));
                var h = b(b.find(".filtertext2" + this.element.id));
            ...
            if (this.groupable) {
                var k = "mousemove.grouping" + this.element.id;
                var e = "mousedown.grouping" + this.element.id;
                var i = "mouseup.grouping" + this.element.id;
                this.removeHandler(b(document), k);
        ...
        _addHandlers: function () {
            ...
            if (!d) {
                ...
                this.addHandler(b(document), "mousemove.selection" + this.element.id, function (j) {
        ...
        _handlemousedown: function (O, l) {
            ...
            if (b(O.target).ischildof(this.columnsheader)) {
                return true
            }
            var m;
            if (O.which) {
            ...
            if (this.showstatusbar) {
                if (b(O.target).ischildof(this.statusbar)) {
                    return true
                }
                if (O.target == this.statusbar[0]) {
                    return true
                }
            }
            var M = this.showheader ? this.columnsheader.height() + 2 : 0;
            var t = this._groupsheader() ? this.groupsheader.height() : 0;
            var w = this.showtoolbar ? this.toolbarheight : 0;
            t += w;
            var K = this.host.coord();
            if (this.hasTransform) {
                K = b.jqx.utilities.getOffset(this.host);
                var Q = this._getBodyOffset();
                K.left -= Q.left;
                K.top -= Q.top
            }
            var h = parseInt(O.pageX);
            var j = parseInt(O.pageY);
            if (this.isTouchDevice()) {
                var P = l.getTouches(O);
                var G = P[0];
                h = parseInt(G.pageX);
                j = parseInt(G.pageY);
                if (l.touchmode == true) {
            ...
            if (this.pageable && !this.autoheight && this.gotopage) {
                var d = this.pager.coord().top - K.top - t - M;
                if (A > d) {
                    return
                }
            }
            var L = this._hittestrow(B, A);
            if (!L) {
                return
            }
            if (L.details) {
            ...
            var p = L.row;
            var v = L.index;
            var q = O.target.className;
            var g = this.table[0].rows[v];
            if (g == null) {
            ...
            for (var I = 0; I < g.cells.length; I++) {
                var J = parseInt(b(this.columnsrow[0].cells[I]).css("left"));
                var h = J - s;
                if (l.columns.records[I].pinned && !l.rtl) {
                    h = J
                }
                var C = this._getcolumnat(I);
                if (C != null && C.hidden) {
                    continue
                }
                var D = h + b(this.columnsrow[0].cells[I]).width();
                if (D >= B && B >= h) {
                    z = I;
                    l.mousecaptureposition.clickedcell = I;
                    break
                }
            }
            if (this.rtl && this._haspinned) {
                for (var I = g.cells.length - 1; I >= 0; I--) {
                    if (!l.columns.records[I].pinned) {
                        break
                    }
                    var J = b(this.columnsrow[0].cells[I]).coord().left - this.host.coord().left;
                    var h = J;
                    var C = this._getcolumnat(I);
                    if (C != null && C.hidden) {
                        continue
            ...
            if (p != null && z >= 0) {
                ...
                var C = this._getcolumnat(z);
                var E = this.getcellvalue(this.getboundindex(p), C.datafield);
                if (this.editable && this.editcell) {
                    if (C.datafield == this.editcell.column) {
                ...
                if (this.isTouchDevice()) {
                    if (C.columntype == "checkbox" && this.editable && this._overlayElement) {
                        if (!this.editcell) {
                            this._overlayElement.css("visibility", "hidden");
                            this.editcell = this.getcell(v, C.datafield);
                            return true
                        }
                    } else {
                        if (C.columntype == "button" && this._overlayElement) {
                            if (C.buttonclick) {
                                C.buttonclick(g.cells[z].buttonrow, O)
                            }
                            return true
                        }
                    }
                ...
                if (this._lastmousedown != null) {
                    if (this._mousedown - this._lastmousedown < 300) {
                        if (this._clickedrowindex == this.getboundindex(p)) {
                            ...
                            if (this._clickedcolumn == C.datafield) {
                                this._raiseEvent(23, {
                                    rowindex: this.getboundindex(p),
                                    column: C ? C.getcolumnproperties() : null,
                                    datafield: C ? C.datafield : null,
                            ...
                            if (O.isPropagationStopped && O.isPropagationStopped()) {
                                return false
                            }
                        }
                    }
                ...
                if (q.indexOf("jqx-grid-group-expand") != -1 || q.indexOf("jqx-grid-group-collapse") != -1) {
                    if (!this.rtl) {
                        if (u > 0 && z < u && this._togglegroupstate) {
                            this._togglegroupstate(p.bounddata, true)
                        } else {
                            if (z == u && this.rowdetails && this.showrowdetailscolumn) {
                        ...
                        if (u > 0 && z > g.cells.length - u - 1 && this._togglegroupstate) {
                            this._togglegroupstate(p.bounddata, true)
                        } else {
                            if (z == g.cells.length - 1 - u && this.rowdetails && this.showrowdetailscolumn) {
                                this._togglerowdetails(p.bounddata, true);
                                this.gridcontent[0].scrollTop = 0;
                                this.gridcontent[0].scrollLeft = 0
                            }
                    ...
                    if (p.boundindex != -1) {
                        ...
                        if (l.selectionmode != "none" && l.selectionmode != "checkbox" && this._selectrowwithmouse) {
                            if (l.selectionmode == "multiplecellsadvanced" || l.selectionmode == "multiplecellsextended" || l.selectionmode == "multiplerowsextended") {
                            ...
                            if (l.selectionmode.indexOf("cell") == -1) {
                                if ((l.selectionmode != "singlerow") || (l.selectedrowindex != o && l.selectionmode == "singlerow")) {
                                    this._applyrowselection(o, true, false, null, C.datafield);
                                    this._selectrowwithmouse(l, L, n, C.datafield, O.ctrlKey, O.shiftKey)
                                }
                            } else {
                                if (C.datafield != null) {
                                    this._selectrowwithmouse(l, L, n, C.datafield, O.ctrlKey, O.shiftKey);
                                    this._applycellselection(o, C.datafield, true, false)
                                }
                        ...
                        if (l.editable && l.begincelledit) {
                            var F = l.editmode == "click" || (N && l.editmode == "selectedcell");
                            if (l.selectionmode.indexOf("cell") == -1) {
                            ...
                            if (F) {
                                if (p.boundindex != undefined && C.editable) {
                                    var r = l.begincelledit(this.getboundindex(p), C.datafield, C.defaulteditorvalue)
                                }
                            }
                            if (l.selectionmode.indexOf("cell") != -1) {
                                if (l.editmode == "selectedcell" && !N && l.editcell) {
                                    l.endcelledit(l.editcell.row, l.editcell.column, false, true)
                                }
                            }
                            return true
    ...
    b.jqx.dataview = function () {
        ...
        this.loadflatrecords = function (d, o, e, p, l, u, n, q) {
            ...
            if (this.pageable) {
                if (this.virtualmode) {
                    if (!this.groupable || this.groups.length == 0) {
                        this.loadflatrecords(this.pagesize * this.pagenum, this.pagesize * (1 + this.pagenum), e, m, j, r, l, []);
                        ...
                        if (this.groupable && this.groups.length > 0 && this.loadgrouprecords) {
                            ...
                            this.loadgrouprecords(0, this.pagesize * this.pagenum, this.pagesize * (1 + this.pagenum), e, m, j, r, l, []);
                ...
                if (this.virtualmode && (!this.groupable || this.groups.length == 0)) {
                    ...
                    if (n != null && o != null) {
                        this.loadflatrecords(n, o, e, m, j, r, l, [])
                    } else {
                        this.loadflatrecords(this.pagesize * this.pagenum, this.pagesize * (1 + this.pagenum), e, m, j, r, l, [])
                    }
                ...
                r = this._updategroupsinpage(q, e, k, m, l, this.pagesize * this.pagenum, this.pagesize * (1 + this.pagenum))
            } else {
                for (var h = this.pagesize * this.pagenum; h < this.pagesize * (1 + this.pagenum); h++) {
                    var p = h < this.loadedrecords.length ? this.loadedrecords[h] : null;
                    if (p == null) {
                        continue
                    }
            ...
            } if ((r.length == 0 || r.length < this.pagesize) && !this.pageable && this.virtualmode) {
                m = r.length;
                var f = r.length;
