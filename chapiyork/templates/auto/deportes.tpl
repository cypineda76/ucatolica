						...
						<div class="specials">
							<div class="specials-grids">
								<div class="special-grid">
									...
									<h3 class="style"><a href="#" onclick="detalle({$noticias[1].artcod});" >{$noticias[1].artnom}</a></p>
									{if $usuario !=''}<button id="vtnedit" name="vtnedit" class="btn btn-warning" onclick="editarNoticia({$noticias[1].artcod});">Editar</button>{/if}</h3>
									<p class="para">{$noticias[1].resumen}
								</div>
								<div class="special-grid">
									<div class="gallery img_style">
